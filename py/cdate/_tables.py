           ...
           'locales': {'de': {'long': '{day}. {month_long} {yyyy}',
                       ...
                       'fr': {'long': '{day} {month_long} {yyyy}',
                              ...
                              'months_short': ['janv.',
                                               ...
                                               'déc.'],
                              'short': '{dd}/{mm}/{yyyy}'},
                       'fr-ch': {'long': '{day} {month_long} {yyyy}',
                                 'medium': '{day} {month_short} {yyyy}',
                                 'month_year': '{month_long} {yyyy}',
                                 'months_long': ['janvier',
                                                 'février',
                       ...
                       'it': {'long': '{day} {month_long} {yyyy}',
                              ...
                              'months_short': ['gen',
                                               ...
                                               'dic'],
                              'short': '{dd}/{mm}/{yy}'},
                       'it-ch': {'long': '{day} {month_long} {yyyy}',
                                 'medium': '{day} {month_short} {yyyy}',
                                 'month_year': '{month_long} {yyyy}',
                                 'months_long': ['gennaio',
                                                 'febbraio',
                                 ...
                                 'months_short': ['gen',
                                                  ...
                                                  'dic'],
                                 'short': '{dd}.{mm}.{yy}'},
                       'rm': {'long': '{day} {month_long} {yyyy}',
                              'medium': '{dd}-{mm}-{yyyy}',
                              'month_year': '{month_long} {yyyy}',
                              'months_long': ['da schaner',
                                              'da favrer',
                                              'da mars',
                                              'd’avrigl',
                                              'da matg',
