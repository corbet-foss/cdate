...
1. Update versions and CHANGELOG.md (a `## X.Y.Z - date` section becomes the
   ...
   `bash js/@corbet-labs/cdate/scripts/sync-assets.sh`. Commit to `main`.
...
Until npm and PyPI trust `corbet-foss/cdate:release.yml`, upload them from the
...
```sh
tag=vX.Y.Z repo=corbet-foss/cdate rev=27c248aefa3c7198be6716a884d290c717774b21
